...
//go:generate sh -c "go tool mockgen -typed -build_flags=\"-tags=gomock\" -package internal -destination internal/tracer.go github.com/Noooste/uquic-go/internal/mocks/logging Tracer"
...
//go:generate sh -c "go tool mockgen -typed -build_flags=\"-tags=gomock\" -package internal -destination internal/connection_tracer.go github.com/Noooste/uquic-go/internal/mocks/logging ConnectionTracer"
